...
def test_get_accounts_success(client: FlaskClient, valid_headers):
    response = client.get("/api/v2/accounts", headers=valid_headers)
...
def test_get_account_success(client: FlaskClient, valid_headers):
    response = client.get("/api/v2/accounts/devel", headers=valid_headers)
    assert response.status_code == 200
