...
class ClientsResource(Resource):
    ...
    def assign(self, client_id: Any, payload: dict, header=None, *, query=None):
        """POST /iscsi/clients/{client_id}/disks"""
        return self._call(
            "POST",
    ...
    def unassign(self, client_id: Any, disk_id: Any, header=None, *, query=None):
        """DELETE /iscsi/clients/{client_id}/disks/{disk_id}"""
        return self._call(
            "DELETE",
